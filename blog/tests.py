...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        response = self.client.get('/bolg/')
        # 1.2. 정상적으로 페이지가 로드된다
        self.assertEqual(response.status_code, 200)
        # 1.3 페이지 타이 은 ‘Blog’ 이다.
        ...
        # 2.2 . main area 에 '아직 게시 물이 없습니다'라는 문구가 나타난다.
        ...
        # 3.3 '아직 게시물이 없습니다'라는 문구는 더이상 더시상 보이지 않는다.
        main_area = soup.find('div', id = 'main-area')
    ...
    def test_post_detail(self):
        ...
        # 2. 1. 첫 번째 포스트으I url로 접근하면 정상적으로 작동한다(status code: 200).
        ...
        self.assertIn(post_001.tit1e, post_area.text)
